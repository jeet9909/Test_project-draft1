...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes, for collaborations involving novel compound discovery where significant intellectual contribution is demonstrated.',
  },
  {
      ...
      {faqs.map((faq, i) => (
        ...
        >
          <button
            ...
            className="w-full text-left px-6 py-4 flex items-start justify-between gap-4 focus:outline-none cursor-pointer"
            aria-expanded={open === i}
          >
            <span className="font-sans font-medium text-[14px] md:text-[15px] text-slate dark:text-gray-100">
              {faq.q}
            </span>
            <ChevronDown
              size={18}
