  ...
  return (
    <>
      ...
      <section className="relative pt-28 md:pt-36 pb-16 section-pad bg-white dark:bg-navy overflow-hidden">
        ...
        <div className="absolute -bottom-16 -left-16 w-[300px] h-[300px] rounded-full bg-coral/4 blur-3xl pointer-events-none" />
        ...
        <div className="relative max-w-3xl">
          <AnimateIn>
            ...
            <p className="text-[16px] text-gray-500 dark:text-gray-400 max-w-xl leading-relaxed mb-8">
              ...
              the speed and scientific rigour of <em>C. elegans</em> biology to your research goals.
            </p>
      ...
      {/* ── MAIN GRID ─────────────────────────────────────── */}
      <section className="section-pad py-16 md:py-20 bg-offwhite dark:bg-gray-900">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-3 text-[14px] text-slate dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:border-teal focus:ring-1 focus:ring-teal/20 transition-all"
                        />
                      </div>
                      <div>
                        <label className="block text-[11px] font-semibold text-slate dark:text-gray-300 mb-1.5 uppercase tracking-wider">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-3 text-[14px] text-slate dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:border-teal focus:ring-1 focus:ring-teal/20 transition-all resize-none"
                      />
                    </div>
                    <button
                      type="submit"
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#1fb956] text-white py-3 rounded-xl text-[13px] font-semibold transition-colors mt-5"
                >
