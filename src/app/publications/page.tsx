...
const PUBS = [
  ...
  { id: 1,  title: "Berberine Attenuates Chromobacterium violaceum's Virulence by Targeting Efflux and Denitrification Machinery", journal: 'Chemistry & Biodiversity', year: 2026, doi: 'https://doi.org/10.1002/cbdv.202503727', pmid: '42127231', pmcid: null, tag: 'Anti-Pathogenic', oa: false },
  ...
  { id: 8,  title: 'Duration of fermentation affects microbiome composition and biological activity of an Indian traditional formulation – Panchagavya', journal: 'Journal of Ayurveda and Integrative Medicine', year: 2024, doi: 'https://doi.org/10.1016/j.jaim.2023.100880', pmid: null, pmcid: 'PMC10940934', tag: 'Microbiome', oa: true },
  ...
  { id: 12, title: 'Network analysis for identifying potential anti-virulence targets from whole transcriptome of Pseudomonas aeruginosa and Staphylococcus aureus exposed to certain anti-pathogenic polyherbal formulations', journal: 'Drug Target Insights', year: 2023, doi: 'https://doi.org/10.33393/dti.2022.2595', pmid: '37275512', pmcid: null, tag: 'Anti-Pathogenic', oa: false },
